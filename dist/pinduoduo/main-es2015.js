...
const routes = [
    { path: '', loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(mod => mod.HomeModule) },
];
...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        this.selectedIndex$ = this.route.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(evt => evt instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((evt) => {
            const arr = evt.url.split('/');
            // console.log('arr============', arr);
            return arr.length > 0 ? arr[1] : 'home';
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(path => this.getSelectedIndex(path)));
    }
    tabSelected(tab) {
        this.route.navigate([tab.link]);
    }
    getSelectedIndex(tab) {
...
let CategoryContainerComponent = class CategoryContainerComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CloseDialogDirective = class CloseDialogDirective {
...
CloseDialogDirective.ctorParameters = () => [
...
let DialogService = class DialogService {
    constructor(domService, document) {
...
let DomService = class DomService {
    constructor(resolver, appRef, injector, document) {
    ...
    appendComponentTo(parentId, child, childConfig) {
        ...
        const childDOMElement = childComponentRef.hostView.rootNodes[0];
...
let HomeContainerComponent = class HomeContainerComponent {
    constructor(router, homeService, route) {
        ...
        this.topMenus$ = this.homeService.getTabs().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(param => param.data !== undefined), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(param => param.data));
    }
    ngOnInit() {
        this.selectedTabLink$ = this.route.firstChild.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(params => params.has('variable')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(params => params.get('variable')));
    }
    handleTapSelected(menu) {
        this.router.navigate(['/home', menu.link]);
    }
};
HomeContainerComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let HomeDetailComponent = class HomeDetailComponent {
    constructor(route, homeService, ref) {
        this.route = route;
        this.homeService = homeService;
        this.ref = ref;
        ...
        // });
        this.imageSlider$ = this.homeService.getImages().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((param) => param.data));
        // this.homeService.getChannels().subscribe((res: any) => {
        //   this.channels = res.data;
        //   console.log('this.channels', this.channels);
        //   this.ref.markForCheck();
        // });
        this.channels$ = this.homeService.getChannels().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((param) => param.data));
    ...
    ngOnInit() {
        ...
        //   // this.ref.markForCheck();
        // });
        this.selecedTab$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(param => param.has('variable')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(param => param.get('variable')));
        // this.route.queryParamMap.subscribe(params => {
        //   console.log('查询参数', params);
        // });
        this.ad$ = this.selecedTab$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(tab => {
            return this.homeService.getAdsByTab(tab).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(res => res.data[0]));
        }));
        this.products$ = this.homeService.getProductsByTab().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(products => products.data));
    }
};
HomeDetailComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_3__["HomeService"] },
...
/*!*******************************!*\
  !*** ./src/app/home/index.ts ***!
  \*******************************/
/*! exports provided: HomeModule, ParamInterceptor, NotificationInterceptor, HomeService, HomeContainerComponent, HomeDetailComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
let ParamInterceptor = class ParamInterceptor {
    intercept(req, next) {
...
let MyContainerComponent = class MyContainerComponent {
...
MyContainerComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
];
...
let MyRoutingModule = class MyRoutingModule {
};
...
let ComfirmOrderComponent = class ComfirmOrderComponent {
    constructor(dialogService) {
        this.dialogService = dialogService;
    ...
    ngOnInit() {
        ...
        this.item$ = this.dialogService.getData().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(item => console.log('data====', item)));
        const unitPrice$ = this.item$.pipe(
        // tap(item => console.log('item1', item)),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((item) => item.variant.price));
        const amount$ = this.item$.pipe(
        // tap(item => console.log('item2', item)),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])((item) => item.count));
        const mergeCount$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["merge"])(amount$, this.count$);
        this.totalPrice$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])([unitPrice$, mergeCount$]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(([price, amount]) => price * amount));
    }
...
ComfirmOrderComponent.ctorParameters = () => [
...
let GroupShortListComponent = class GroupShortListComponent {
    constructor() {
        this.groupOrders = [];
        this.row = 2;
    }
...
/*!*********************************************!*\
  !*** ./src/app/product/components/index.ts ***!
  \*********************************************/
/*! exports provided: ComfirmOrderComponent, PaymentComponent, ProductContainerComponent, GroupItemComponent, GroupShortListComponent, ProductVariantDialogComponent, ProductAmountComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
let ProductAmountComponent = class ProductAmountComponent {
    constructor() {
        this.count = 0;
...
let ProductContainerComponent = class ProductContainerComponent {
    constructor(router, route, orderService, dialogService) {
        this.router = router;
        this.route = route;
    ...
    ngOnInit() {
        const produstId$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(params => params.has('productId')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(params => params.get('productId')));
        this.variants$ = produstId$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(productId => this.orderService.getProductVariantsByProductId(productId)));
    }
    handleDirectBuy(variants) { }
    handleGroupBuy(variants) {
        const top = 40;
        const formSubmitted = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        formSubmitted.subscribe(ev => {
            this.dialogService.saveData(ev);
            this.router.navigate(['/orders/confirm']);
        });
        const selected = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
...
ProductContainerComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
let ProductVariantDialogComponent = class ProductVariantDialogComponent {
    constructor(dialogService) {
        this.dialogService = dialogService;
        this.variants = [];
...
ProductVariantDialogComponent.ctorParameters = () => [
    { type: src_app_dialog__WEBPACK_IMPORTED_MODULE_2__["DialogService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
/*!**********************************!*\
  !*** ./src/app/product/index.ts ***!
  \**********************************/
/*! exports provided: ProductModule, ComfirmOrderComponent, PaymentComponent, ProductContainerComponent, GroupItemComponent, GroupShortListComponent, ProductVariantDialogComponent, ProductAmountComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
let RecommentContainerComponent = class RecommentContainerComponent {
    constructor(homeService) {
        this.homeService = homeService;
    }
    ngOnInit() {
        this.ad$ = this.homeService.getAdsByTab('hot').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(res => res.data[0]));
        this.products$ = this.homeService.getProductsByTab().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(products => products.data));
    }
};
RecommentContainerComponent.ctorParameters = () => [
...
let RecommendRoutingModule = class RecommendRoutingModule {
};
...
let CountDownComponent = class CountDownComponent {
    ...
    getCountDownObservable(start, future) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(1000).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(elapse => this.diffInSec(start, future) - elapse), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeWhile"])(gap => gap >= 0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(sec => ({
        ...
        // tap(console.log),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(({ hour, minute, second }) => {
...
let HorizontalGridComponent = class HorizontalGridComponent {
    constructor(elr, rd2) {
        this.elr = elr;
        this.rd2 = rd2;
        this.cols = 8;
...
HorizontalGridComponent.ctorParameters = () => [
...
let ScrollableTapComponent = class ScrollableTapComponent {
    /**
     * 构造函数总是第一个被调用
     */
    constructor() {
...
let VerticalGridComponent = class VerticalGridComponent {
    constructor() {
        this.itemWidth = '4rem';
...
let AvatarDirective = class AvatarDirective {
    constructor() {
...
let GridItemImageDirective = class GridItemImageDirective {
    constructor(elr, rd2) {
        this.elr = elr;
        this.rd2 = rd2;
        this.gridArea = 'image';
...
GridItemImageDirective.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let GridItemTitleDirective = class GridItemTitleDirective {
    constructor(elr, rd2) {
        this.elr = elr;
        this.rd2 = rd2;
        this.gridArea = 'title';
...
GridItemTitleDirective.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let GridItemDirective = class GridItemDirective {
    constructor(elr, rd2) {
        this.elr = elr;
        this.rd2 = rd2;
        this.display = 'grid';
...
GridItemDirective.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Renderer2"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let AgoPipePipe = class AgoPipePipe {
